...
public class EmptyTower extends GameObject implements BaseTower {
    ...
    public EmptyTower(int posX, int posY) {
        super(posX, posY, new Image("TheGame/Resources/empty_tower.png"));
        this.upgrade = false;
        buildBarBg = new StaticObject(posX + 20, posY - 15, new Image("TheGame/Resources/buildBar_bg.png"));
    }
    ...
    public void update() {
        if (upgradeRate >= 0) {
            Image tempImage = new Image("TheGame/Resources/buildBar.png", 54 * upgradeRate / 100, 8, false, false);
